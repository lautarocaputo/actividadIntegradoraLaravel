...
@section('content')
<div class="container">
    <section class="container-agregar-libro mt-5">
        ...
        <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control @error('ano_de_publicacion') is-invalid @enderror" name="ano_de_publicacion" id="ano_de_publicacion">
